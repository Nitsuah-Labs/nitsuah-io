      ...
      <div className="resume-profiles">
        ...
        {(url || website) && (
          <a
            ...
            style={{
              background:
                hoveredButton === "website" ? "#ea580c" : "transparent",
              borderColor: "#f97316",
              transform:
        ...
        <a
          ...
          style={{
            background:
              hoveredButton === "projects" ? "#ea580c" : "transparent",
            borderColor: "#f97316",
            transform:
        ...
        {profiles &&
          profiles
            ...
            .map((profile, idx) => (
              <div
                key={`print-li-${idx}`}
                className="resume-profiles-print-row"
              >
          ...
          profiles
            ...
            .map((profile, idx) => (
              <div
                ...
                className="resume-profiles-print-row"
              >
                <span className="resume-profiles-print-label">
                  {profile.network}
                </span>
                <span className="resume-profiles-print-url">
                  {profile.url.replace(/^https?:\/\//, "")}
